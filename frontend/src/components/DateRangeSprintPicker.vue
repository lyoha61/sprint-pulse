...
function findSprintByDateRange(selectedStart, selectedEnd) {
...
<template>
	<div class="relative">
		...
		<div
			v-if="isOpen"
			class="absolute right-0 top-full z-50 mt-2 w-[272px] rounded-xl border border-slate-200 bg-white p-4 shadow-xl"
		>
			...
			<button
				type="button"
				class="w-full rounded-lg bg-violet-600 py-2 text-sm font-medium text-white transition-colors hover:bg-violet-700 disabled:cursor-not-allowed disabled:opacity-40"
